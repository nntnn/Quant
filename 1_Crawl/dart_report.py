...
def webdriver(lnk, **kwarg):
    ...
    # arg_ = {'types':'', 'params':{'':''}}
    arg_ = {}
    arg_keys = ['types', 'params',]
    arg_vals = ['',{},]
    # params
    for k,v in kwarg.items():
        print(k, v)
        # 내가 원하는 키를 썼다면 value에 넣는다
        if k in arg_keys:
            arg_[k] = {v}
            #arg_vals[]
    print(arg_)
...
lnk = 'dart.fss.or.kr/dsaf001/main.do?rcpNo=20200330004441'
parse_params={'script','text/javascript'}
webdriver(lnk, types='script', params={'type':'text/javascript'})
